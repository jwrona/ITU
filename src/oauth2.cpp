...
OAuth2::OAuth2(QWidget* parent)
{
    ...
    m_strScope = "https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/calendar.readonly";
    m_strClientID = "876312718797.apps.googleusercontent.com";
...
{
    QString str = QString("%1?client_id=%2&redirect_uri=%3&response_type=%4&scope=%5&access_type=offline").arg(m_strEndPoint).arg(m_strClientID).
