...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_OAuth2_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 18, 19)
    },
    "OAuth2\0loginDone\0\0accessTokenObtained\0"
};
...
void OAuth2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OAuth2::loginDone)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject OAuth2::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OAuth2.data,
      qt_meta_data_OAuth2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OAuth2.stringdata))
